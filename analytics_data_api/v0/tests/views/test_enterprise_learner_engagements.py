...
class EnterpriseLearnerEngagementViewTests(TestCaseWithAuthentication):
    @classmethod
    def setUpClass(cls):
        super(EnterpriseLearnerEngagementViewTests, cls).setUpClass()

        cls.default_username = 'death_stroke'
        cls.enterprise_customer_uuid = '5c0dd495-e726-46fa-a6a8-2d8d26c716c9'
        cls.path = '/api/v0/enterprise/{}/engagements/'.format(cls.enterprise_customer_uuid)
    ...
    def test_enterprise_learner_engagements_paginatation(self, page, page_size):
        ...
        """
        path = '{base_url}?page={page}&page_size={page_size}'.format(base_url=self.path, page=page, page_size=page_size)
